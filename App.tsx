...
const App = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-slate-50 font-sans overflow-hidden text-slate-800">
      {/* Header kısmı hala Cover sayfasında gizli kalabilir, isterseniz buradaki koşulu da kaldırabilirsiniz */}
      ...
      {/* DÜZELTME BURADA: Footer'ı gizleyen koşul kaldırıldı. Artık ilk sayfada da buton görünecek. */}
